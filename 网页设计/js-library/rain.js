let canvas, ctx, DPR, options, canvasWidth, canvasHeight, wind_anger;
...
const Rain = opts => {
    ...
    let wind_max = 270 + Math.atan(canvas.width / canvas.height) / eachAnger;
    let wind_min = 270 - Math.atan(canvas.width / canvas.height) / eachAnger;
    angle[0] = wind_min + 20;
    angle[1] = wind_max - 20;
